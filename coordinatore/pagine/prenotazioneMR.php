    ...
    <div class="bg-gray-300 p-12 rounded-lg border-4 border-purple-300 w-3/4 lg:w-1/2">
        <div class="flex justify-around mb-12 space-x-8">
            <div class="text-center">
                <div class="<?= getClassePosto('MR1', $prenotazioni, $username) ?> w-32 h-40 rounded-lg mb-2" onclick="makeReservation('MR1')">
                    <?php if (isset($prenotazioni['MR1'])) : ?>
                        <p class="text-xs text-white font-bold"><?= $prenotazioni['MR1'] ?></p>
                    <?php endif; ?>
                </div>
